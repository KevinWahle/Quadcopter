...
## Generated on : Fri Jan 27 16:28:54 2023
...
SRCS = $(START_DIR)\imuFilter_data.c $(START_DIR)\rt_nonfinite.c $(START_DIR)\rtGetNaN.c $(START_DIR)\rtGetInf.c $(START_DIR)\imuFilter_initialize.c $(START_DIR)\imuFilter_terminate.c $(START_DIR)\imuFilter.c $(START_DIR)\IMUFilterBase.c $(START_DIR)\quaternion.c $(START_DIR)\rotmat.c
...
OBJS = imuFilter_data.obj rt_nonfinite.obj rtGetNaN.obj rtGetInf.obj imuFilter_initialize.obj imuFilter_terminate.obj imuFilter.obj IMUFilterBase.obj quaternion.obj rotmat.obj
...
IMUFilterBase.obj : $(START_DIR)\IMUFilterBase.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\IMUFilterBase.c


quaternion.obj : $(START_DIR)\quaternion.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\quaternion.c


rotmat.obj : $(START_DIR)\rotmat.c
	$(CC) $(CFLAGS) -Fo"$@" $(START_DIR)\rotmat.c
